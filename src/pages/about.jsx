...
const About = () => {
  ...
  return (
    <>
      <Head>
        <link rel="alternate" hrefLang="en" href="https://ihelp.org.ua/about" />
        <link rel="alternate" hrefLang="ua" href="https://ihelp.org.ua//ua/about" />
        ...
        <meta property="og:url" content="https://ihelp.org.ua/about" />

        <meta name="twitter:title" content={t("meta.about.title")} />
        <meta name="twitter:description" content={t("meta.about.description")} />

        <title>{t("meta.about.title")}</title>
        <link rel="canonical" href={locale === "ua" ? "https://ihelp.org.ua/ua/about" : "https://ihelp.org.ua/about"} />
      </Head>
